...
import { fetchBlogs, setCurrentPage, deleteBlog } from '../store/slices/blogSlice'
...
const BlogList = () => {
  ...
  const { blogs, loading, error, totalCount, currentPage, pageSize } = useAppSelector(
    (state) => state.blog
  )
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.headerActions}>
          ...
          <Link to="/blogs/create" style={styles.createButton}>
            Create Blog
          </Link>
            ...
            {blogs.map((blog) => (
              <div key={blog.id} style={styles.blogCard}>
                ...
                <div style={styles.blogActions}>
                  <Link to={`/blogs/${blog.id}`} style={styles.viewButton}>
                    View
                  </Link>
                  <Link to={`/blogs/${blog.id}/edit`} style={styles.editButton}>
                    Edit
                  </Link>
                  <button
